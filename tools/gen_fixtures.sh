...
docker run --rm \
  ...
  sh -c '
    ...
    rm -rf blueprint_portrait_expected blueprint_portrait_expected_files blueprint_portrait_expected.dzi
    ...
    rm -rf blueprint_mix_expected blueprint_mix_expected_files blueprint_mix_expected.dzi
    ...
    rm -rf blueprint_portrait_google_centre
    ...
    rm -rf blueprint_mix_google_centre
