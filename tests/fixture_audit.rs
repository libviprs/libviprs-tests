...
const FIXTURE_DEPS: &[(&str, &[&str])] = &[
    ("1.webp", &["ported_foreign::test_webp"]),
    (
    ...
    ("MARBLES.BMP", &["ported_foreign::test_magickload"]),
    (
    ...
    ("cd2.2.jpg", &["ported_mosaicing::test_mosaic"]),
    ("cd3.1.jpg", &["ported_mosaicing::test_mosaic"]),
    ("cd3.2.jpg", &["ported_mosaicing::test_mosaic"]),
    ("cd4.1.jpg", &["ported_mosaicing::test_mosaic"]),
    ("cd4.2.jpg", &["ported_mosaicing::test_mosaic"]),
    ("cmyktest.pdf", &["ported_foreign::test_pdf_cmyk"]),
    ("cogs.gif", &["ported_foreign::test_magickload"]),
    ("dicom_test_image.dcm", &["ported_foreign::test_magickload"]),
    (
    ...
    ("favicon.ico", &["ported_foreign::test_magickload"]),
    ("garden.gif", &["ported_foreign::test_gifload_frame_error"]),
    ("indexed.png", &["ported_foreign::test_png_load_palette"]),
    ("logo.svg", &["ported_foreign::test_magickload"]),
    (
        "multi-channel-z-series.ome.tif",
        &["ported_foreign::test_tiff_multipage"],
    ),
    ("ojpeg-strip.tif", &["ported_foreign::test_tiff_ojpeg"]),
    (
        "ojpeg-tile.tif",
        &[
    ...
    ("rgba-correct.ppm", &["ported_foreign::test_ppm"]),
    (
        "rgba.png",
        &[
    ...
    ("sample-xyb.jpg", &["ported_resample::test_thumbnail_icc"]),
    ("sample.cur", &["ported_foreign::test_magickload"]),
    ("sample.exr", &["ported_foreign::test_openexrload"]),
    (
        "sample.hdr",
        &[
    ...
    ("sample.mat", &["ported_foreign::test_matload"]),
    (
        "sample.png",
        &[
    ...
    ("silicongraphics.sgi", &["ported_foreign::test_magickload"]),
    ("subsampled.tif", &["ported_foreign::test_tiff_subsampled"]),
    ("targa.tga", &["ported_foreign::test_magickload"]),
    (
        "trans-x.gif",
        &[
    ...
    ("truncated.gif", &["ported_foreign::test_gifload_truncated"]),
    ("truncated.jpg", &["ported_foreign::test_truncated"]),
    (
        "ultra-hdr.jpg",
        &[
    ...
    ("world.jp2", &["ported_foreign::test_jp2kload"]),
];
...
fn fixture_audit_summary() {
    ...
    report.push_str(
        "To fix: add the missing files to the images directory,\n\
